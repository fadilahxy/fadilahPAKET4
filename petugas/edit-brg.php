...
$sql = $koneksi->query("SELECT * FROM produk WHERE Produk_id = '$id'");
...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES['foto']['name'] !=='') {
        ...
        $fotlam = $data['Foto_produk'];
        unlink("../foto/".$fotlam);
        $sql = $koneksi->query("UPDATE produk SET Nama_produk='$name', Harga='$harga', Stok='$stok', Foto_produk='$filename' WHERE Produk_id= '$id'");
        echo "<script>alert('Berhasil Mengubah Data Barang'); window.location.href='?page=stok';</script>";
        
    } else {
        $sql = $koneksi->query("UPDATE produk SET Nama_produk='$name', Harga='$harga', Stok='$stok' WHERE Produk_id = '$id'");
        echo "<script>alert('Berhasil Mengubah Data Barang'); window.location.href='?page=stok';</script>";
    }
}
?>
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="NamaProduk"  value="<?php echo $data['Nama_produk']; ?>" placeholder="Enter Name" name="Nama_produk">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <p><?php echo "<img src='../foto/".$data['Foto_produk']."' width='70' height='70'></img>"; ?>

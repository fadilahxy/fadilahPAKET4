            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Add class <code>.table</code> -->
                        <a href="?page=tambah-brg" title="Tambah Barang"
                    ...
                    <div class="table-responsive">
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="center" width="12%"><a href="?page=edit-brg&Produk_id=<?= $data['Produk_id'];?>" class="badge badge-primary p-2" title="Edit"><i class="">Edit</i></a> | <a href="?page=hapus-brg&Produk_id=<?= $data['Produk_id']; ?>" class="badge badge-danger p-2 delete-data" onclick="return confirm('Anda Yakin Ingin Menghapus Barang Ini!?')">Delete</i></a></td>
                                <td></td>
                                <td>
